...
@section('content')
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form data-action="{{ route('admin.edit.user.role', Crypt::encrypt($user->id)) }}"
                    class="adminFrm form-horizontal" method="POST" data-class="requiredCheck">
                    @csrf
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="user_role" id="user_role" class="form-select">
                                {{ getRolesList($user->roles->first()->id) }}
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
