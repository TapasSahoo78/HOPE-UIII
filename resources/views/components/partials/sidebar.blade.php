<aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="../dashboard/index.html" class="navbar-brand">
            ...
            <!--logo End-->
            <h4 class="logo-title">IIFON ADMIN</h4>
        </a>
        ...
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                @if (auth()->user()->hasRole('admin'))
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#role-menu" role="button"
                        ...
                        <ul class="sub-nav collapse" id="role-menu" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                ...
                                <a class="nav-link " href="{{ route('admin.list.user.role') }}">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                    ...
                                    <i class="sidenav-mini-icon"> H </i>
                                    <span class="item-name"> Assign User </span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('admin.role.store') }}" target="_blank">
                        <i class="icon">
